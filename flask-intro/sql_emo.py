...
conn.execute('CREATE TABLE submissions (happy INTEGER, excited INTEGER, energetic INTEGER, angry INTEGER, stressed INTEGER, frustrated INTEGER, upset INTEGER, tired INTEGER, lost INTEGER, sad INTEGER, calm INTEGER, content INTEGER, tags TEXT)')
